...
deploy-lusd-op :; forge script script/DeployOptLUSDPayload.s.sol:DeployPayloadOptimism --rpc-url optimism --broadcast --legacy --private-key ${PRIVATE_KEY} --verify -vvvv
