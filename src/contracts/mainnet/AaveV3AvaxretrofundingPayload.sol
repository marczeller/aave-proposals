...
contract AaveV3AvaxretrofundingPayload is IProposalGenericExecutor {
    ...
    uint256 public constant AMOUNT_aAvaWAVAX = 9_584_300000000000000000; // $182,723,768
    uint256 public constant AMOUNT_aAvaWBTC = 1_08000000; // $21,529,26


    function execute() external {
        AaveV3Avalanche.COLLECTOR_CONTROLLER.transfer(aAvaWAVAX, AAVECO_ADDRESS, AMOUNT_aAvaWAVAX);
        AaveV3Avalanche.COLLECTOR_CONTROLLER.transfer(aAvaWBTC, AAVECO_ADDRESS, AMOUNT_aAvaWBTC);
    }
}